...
},{}],"../node_modules/shortcut-buttons-flatpickr/dist/shortcut-buttons-flatpickr.js":[function(require,module,exports) {
var define;
(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === 'object' && typeof module === 'object') module.exports = factory();else if (typeof define === 'function' && define.amd) define([], factory);else if (typeof exports === 'object') exports["ShortcutButtonsPlugin"] = factory();else root["ShortcutButtonsPlugin"] = factory();
})(window, function () {
  return (
    /******/
    function (modules) {
    ...
    ({
      ...
      function (module, exports, __webpack_require__) {
        ...
        function ShortcutButtonsPlugin(config) {
          var cfg = __assign({}, defaultConfig, config);
          ...
          return function (fp) {
            ...
            function onClick(event) {
              ...
              var callbacks = Array.isArray(cfg.onClick) ? cfg.onClick : [cfg.onClick];
            ...
            function setButtonsAttributes(button, attributes) {
              Object.keys(attributes).filter(function (attribute) {
...
},{}],"../node_modules/flatpickr/dist/l10n/ru.js":[function(require,module,exports) {
var define;
var global = arguments[3];
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define(['exports'], factory) : (global = global || self, factory(global.ru = {}));
...
var _shortcutButtonsFlatpickr = _interopRequireDefault(require("shortcut-buttons-flatpickr"));

var _ru = require("flatpickr/dist/l10n/ru.js");
...
$(document).ready(function () {
  ...
  $('.ts-chooser input:first').val('Нур-Султан, Казахстан'); // end demo
  ...
  $('.ts-chooser__input').on('hidden.bs.dropdown', function (e) {
    var input_value = $(this).find('.ts-input')[0].value;
  ...
  var second_date = (0, _flatpickr.default)(".js--dates-to", {
    plugins: [(0, _shortcutButtonsFlatpickr.default)({
      button: {
  ...
  (0, _flatpickr.default)(".js--dates-from", {
    dateFormat: "d.m.Y",
    minDate: "today",
    locale: _ru.Russian,
    onChange: function onChange(index, fp) {
      start_day.push(index[0]);
      second_date.set('');
    }
  });
});
},{"flatpickr":"../node_modules/flatpickr/dist/flatpickr.js","shortcut-buttons-flatpickr":"../node_modules/shortcut-buttons-flatpickr/dist/shortcut-buttons-flatpickr.js","flatpickr/dist/l10n/ru.js":"../node_modules/flatpickr/dist/l10n/ru.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
